...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.autocrab", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.autocrab", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: AutoCrabProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
