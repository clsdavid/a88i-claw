...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = AutoCrabChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = AutoCrabChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
