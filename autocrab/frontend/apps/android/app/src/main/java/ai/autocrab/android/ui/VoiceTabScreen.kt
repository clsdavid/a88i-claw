...
import ai.autocrab.android.voice.VoiceConversationRole
  ...
  Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Start) {
    Surface(
      ...
      Row(
        ...
        Text("AutoCrab is thinking…", style = mobileCallout, color = mobileTextSecondary)
      }
    }
  }
}
