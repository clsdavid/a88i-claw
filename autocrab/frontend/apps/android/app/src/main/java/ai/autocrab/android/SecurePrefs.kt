...
class SecurePrefs(context: Context) {
  companion object {
    val defaultWakeWords: List<String> = listOf("autocrab", "claude")
    private const val displayNameKey = "node.displayName"
    private const val voiceWakeModeKey = "voiceWake.mode"
    private const val plainPrefsName = "autocrab.node"
    private const val securePrefsName = "autocrab.node.secure"
  }
