...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.autocrab", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("AutoCrab/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__autocrab__/a2ui/").absoluteString + "?platform=macos"
    }
