...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.autocrab", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        AutoCrabPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        AutoCrabPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
