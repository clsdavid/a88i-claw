...
enum UIStrings {
    static let welcomeTitle = "Welcome to AutoCrab"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "autocrab.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: AutoCrabChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g autocrab@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: AutoCrabChatViewModel(
