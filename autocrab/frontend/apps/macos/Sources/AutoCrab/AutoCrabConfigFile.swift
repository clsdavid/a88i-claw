...
enum AutoCrabConfigFile {
    private static let logger = Logger(subsystem: "ai.autocrab", category: "config")
    ...
    static func stateDirURL() -> URL {
        AutoCrabPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        AutoCrabPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-autocrab-config-file",
            "event": "config.write",
