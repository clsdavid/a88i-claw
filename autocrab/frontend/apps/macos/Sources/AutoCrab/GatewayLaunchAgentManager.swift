...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.autocrab", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".autocrab/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.autocrabCommand(
            subcommand: "gateway",
