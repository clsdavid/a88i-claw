...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.autocrab", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other AutoCrab windows, but below the system’s pop-up menus.
