...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = AutoCrabLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = AutoCrabLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.autocrab.ios", category: "GatewaySettings")
    ...
    var body: some View {
        NavigationStack {
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        self.featureToggle(
                            ...
                            help: "Enables voice conversation mode with your connected AutoCrab agent.") { newValue in
                        ...
                        self.featureToggle(
                            ...
                            help: "Allows the gateway to request photos or short video clips "
                                + "while AutoCrab is foregrounded."
                        )
                        ...
                        HStack(spacing: 8) {
                            ...
                            Button {
                                self.activeFeatureHelp = FeatureHelp(
                                    ...
                                    message: "Controls location permissions for AutoCrab. "
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(AutoCrabLocationMode.off.rawValue)
                            Text("While Using").tag(AutoCrabLocationMode.whileUsing.rawValue)
                            Text("Always").tag(AutoCrabLocationMode.always.rawValue)
                        }
                        .labelsHidden()
                        ...
                        self.featureToggle(
                            ...
                            help: "Keeps the screen awake while AutoCrab is open.")
                    ...
                    DisclosureGroup("Device Info") {
                        ...
                        LabeledContent("AutoCrab", value: DeviceInfoHelper.autoCrabVersionString())
                    }
                }
            }
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = AutoCrabLocationMode(rawValue: newValue) else { return }
                Task {
