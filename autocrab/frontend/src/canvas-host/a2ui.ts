...
export const A2UI_PATH = "/__autocrab__/a2ui";

export const CANVAS_HOST_PATH = "/__autocrab__/canvas";

export const CANVAS_WS_PATH = "/__autocrab__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.autocrabCanvasA2UIAction.postMessage(...)
  // - Android: window.autocrabCanvasA2UIAction.postMessage(...)
  const handlerNames = ["autocrabCanvasA2UIAction"];
  ...
  globalThis.AutoCrab = globalThis.AutoCrab ?? {};
  globalThis.AutoCrab.postMessage = postToNode;
  globalThis.AutoCrab.sendUserAction = sendUserAction;
  globalThis.autocrabPostMessage = postToNode;
  globalThis.autocrabSendUserAction = sendUserAction;
