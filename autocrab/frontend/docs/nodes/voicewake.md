...
AutoCrab treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.autocrab/settings/voicewake.json`

Shape:

```json
{ "triggers": ["autocrab", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
