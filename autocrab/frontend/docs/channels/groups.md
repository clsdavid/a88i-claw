...
AutoCrab treats group chats consistently across surfaces: WhatsApp, Telegram, Discord, Slack, Signal, iMessage, Microsoft Teams, Zalo.

## Beginner intro (2 minutes)

AutoCrab “lives” on your own messaging accounts. There is no separate WhatsApp bot user.
If **you** are in a group, AutoCrab can see that group and respond there.
...
Translation: allowlisted senders can trigger AutoCrab by mentioning it.
    ...
    list: [
      {
        id: "main",
        groupChat: {
          mentionPatterns: ["@autocrab", "autocrab", "\\+15555550123"],
          historyLimit: 50,
        },
      },
    ],
