---
summary: "Use Qwen OAuth (free tier) in AutoCrab"
read_when:
  - You want to use Qwen with AutoCrab
...
If you already logged in with the Qwen Code CLI, AutoCrab will sync credentials
