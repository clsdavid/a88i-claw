---
summary: "Use NVIDIA's OpenAI-compatible API in AutoCrab"
read_when:
  - You want to use NVIDIA models in AutoCrab
...
autocrab onboard --auth-choice skip
autocrab models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
