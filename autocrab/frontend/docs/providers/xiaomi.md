---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with AutoCrab"
read_when:
  - You want Xiaomi MiMo models in AutoCrab
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). AutoCrab uses
