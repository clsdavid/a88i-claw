...
read_when:
  ...
  - Wiring external systems into AutoCrab
title: "Webhooks"
---
...
- `hooks.transformsDir` + `transform.module` loads a JS/TS module for custom logic.
  - `hooks.transformsDir` (if set) must stay within the transforms root under your AutoCrab config directory (typically `~/.autocrab/hooks/transforms`).
...
- `autocrab webhooks gmail setup` writes `hooks.gmail` config for `autocrab webhooks gmail run`.
