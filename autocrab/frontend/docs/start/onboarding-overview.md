---
summary: "Overview of AutoCrab onboarding options and flows"
read_when:
...
AutoCrab supports multiple onboarding paths depending on where the Gateway runs
...
- [`autocrab onboard` command](/cli/onboard)

## macOS app onboarding

Use the AutoCrab app when you want a fully guided setup on macOS. Docs:
