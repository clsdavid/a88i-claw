---
summary: "First-run onboarding flow for AutoCrab (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give AutoCrab">
...
<Step title="CLI">
  ...
  The app can install the global `autocrab` CLI via npm/pnpm so terminal
