---
summary: "VPS hosting hub for AutoCrab (Oracle/Fly/Hetzner/GCP/exe.dev)"
read_when:
...
- `AUTOCRAB_NO_RESPAWN=1` avoids extra startup overhead from a self-respawn path.
...
- Add service env for stable startup path:
  - `AUTOCRAB_NO_RESPAWN=1`
  - `NODE_COMPILE_CACHE=/var/tmp/autocrab-compile-cache`
