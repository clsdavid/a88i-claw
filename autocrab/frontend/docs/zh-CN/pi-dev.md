...
本指南总结了在 AutoCrab 中开发 Pi 集成的合理工作流程。
...
状态存储在 AutoCrab 状态目录下。默认为 `~/.autocrab`。如果设置了 `AUTOCRAB_STATE_DIR`，则使用该目录。
...
- https://docs.autocrab.ai/testing
- https://docs.autocrab.ai/start/getting-started
