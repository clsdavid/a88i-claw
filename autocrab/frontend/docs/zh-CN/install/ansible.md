...
将 AutoCrab 部署到生产服务器的推荐方式是通过 **[autocrab-ansible](https://github.com/clsdavid/autocrab-ansible)** — 一个安全优先架构的自动化安装程序。
...
> **📦 完整指南：[github.com/autocrab/autocrab-ansible](https://github.com/clsdavid/autocrab-ansible)**
>
...
- [安全架构](https://github.com/clsdavid/autocrab-ansible/blob/main/docs/security.md)
- [技术详情](https://github.com/clsdavid/autocrab-ansible/blob/main/docs/architecture.md)
- [故障排除指南](https://github.com/clsdavid/autocrab-ansible/blob/main/docs/troubleshooting.md)

## 相关内容

- [autocrab-ansible](https://github.com/clsdavid/autocrab-ansible) — 完整部署指南
