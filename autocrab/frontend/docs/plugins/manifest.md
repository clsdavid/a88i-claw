...
read_when:
  - You are building a AutoCrab plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (autocrab.plugin.json)

Every plugin **must** ship a `autocrab.plugin.json` file in the **plugin root**.
AutoCrab uses this manifest to validate configuration **without executing plugin
