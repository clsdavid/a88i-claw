...
export const es: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Editar ~/.autocrab/autocrab.json de forma segura.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "¿En el móvil? Copia la URL completa (incluyendo #token=...) desde autocrab dashboard --no-open en tu escritorio.",
    },
    insecure: {
