...
export const de: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "~/.autocrab/autocrab.json sicher bearbeiten.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Auf dem Mobilgerät? Kopieren Sie die vollständige URL (einschließlich #token=...) von autocrab dashboard --no-open auf Ihrem Desktop.",
    },
    insecure: {
