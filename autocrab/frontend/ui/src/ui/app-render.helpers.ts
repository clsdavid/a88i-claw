...
import { AutoCrabApp } from "./app.ts";
...
function resetChatStateForSessionSwitch(state: AppViewState, sessionKey: string) {
  ...
  (state as unknown as AutoCrabApp).chatStreamStartedAt = null;
  state.chatRunId = null;
  (state as unknown as AutoCrabApp).resetToolStream();
  (state as unknown as AutoCrabApp).resetChatScroll();
  state.applySettings({
    ...state.settings,
    sessionKey,
  ...
  return html`
    <div class="chat-controls">
      ...
      <button
        ...
        @click=${async () => {
          const app = state as unknown as AutoCrabApp;
