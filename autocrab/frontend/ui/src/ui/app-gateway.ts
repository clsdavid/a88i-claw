...
export function connectGateway(host: GatewayHost) {
  ...
  const client = new GatewayBrowserClient({
    ...
    clientName: "autocrab-control-ui",
    clientVersion,
    mode: "webchat",
    ...
    onHello: (hello) => {
      ...
      void loadAssistantIdentity(host as unknown as AutoCrabApp);
      void loadAgents(host as unknown as AutoCrabApp);
      void loadToolsCatalog(host as unknown as AutoCrabApp);
      void loadNodes(host as unknown as AutoCrabApp, { quiet: true });
      void loadDevices(host as unknown as AutoCrabApp, { quiet: true });
...
function handleTerminalChatEvent(
  ...
  if (state === "final") {
    void loadSessions(host as unknown as AutoCrabApp, {
...
function handleChatGatewayEvent(host: GatewayHost, payload: ChatEventPayload | undefined) {
  ...
  const state = handleChatEvent(host as unknown as AutoCrabApp, payload);
  handleTerminalChatEvent(host, payload, state);
  if (state === "final" && shouldReloadHistoryForFinalEvent(payload)) {
    void loadChatHistory(host as unknown as AutoCrabApp);
  }
}
