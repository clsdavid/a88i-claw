...
import type { AutoCrabConfig } from "autocrab/plugin-sdk/mattermost";
...
export function listMattermostAccountIds(cfg: AutoCrabConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: AutoCrabConfig): string {
...
export function listEnabledMattermostAccounts(cfg: AutoCrabConfig): ResolvedMattermostAccount[] {
