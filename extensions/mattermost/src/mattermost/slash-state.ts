...
import type { AutoCrabPluginApi } from "autocrab/plugin-sdk/mattermost";
...
export function activateSlashCommands(params: {
  ...
  triggerMap?: Map<string, string>;
  api: {
    cfg: import("autocrab/plugin-sdk/mattermost").AutoCrabConfig;
    runtime: import("autocrab/plugin-sdk/mattermost").RuntimeEnv;
  };
  log?: (msg: string) => void;
}) {
 ...
 */
export function registerSlashCommandRoute(api: AutoCrabPluginApi) {
