...
import type { AutoCrabPluginApi } from "autocrab/plugin-sdk/feishu";
...
function readConfiguredDefaultAccountId(config: AutoCrabPluginApi["config"]): string | undefined {
...
export function resolveFeishuToolAccount(params: {
  api: Pick<AutoCrabPluginApi, "config">;
