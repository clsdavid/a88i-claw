...
import { isSecretRef } from "autocrab/plugin-sdk/googlechat";
import type { AutoCrabConfig } from "autocrab/plugin-sdk/googlechat";
...
export function listGoogleChatAccountIds(cfg: AutoCrabConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: AutoCrabConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: AutoCrabConfig): ResolvedGoogleChatAccount[] {
