...
import type { ReplyPayload, AutoCrabConfig } from "autocrab/plugin-sdk/twitch";
import { createReplyPrefixOptions } from "autocrab/plugin-sdk/twitch";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as AutoCrabConfig;
