...
import type { AutoCrabConfig, RuntimeEnv } from "autocrab/plugin-sdk/msteams";
...
vi.mock("autocrab/plugin-sdk/msteams", () => ({
...
function createConfig(port: number): AutoCrabConfig {
  return {
    channels: {
      msteams: {
        enabled: true,
