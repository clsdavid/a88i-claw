import type { AutoCrabConfig, PluginRuntime, ResolvedLineAccount } from "autocrab/plugin-sdk/line";
...
async function runLogoutScenario(params: { cfg: AutoCrabConfig; accountId: string }): Promise<{
