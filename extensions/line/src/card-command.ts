import type { LineChannelData, AutoCrabPluginApi, ReplyPayload } from "autocrab/plugin-sdk/line";
import {
  createActionCard,
  createImageCard,
  createInfoCard,
...
export function registerLineCardCommand(api: AutoCrabPluginApi): void {
  api.registerCommand({
    name: "card",
