import type { AutoCrabConfig, AutoCrabPluginApi } from "autocrab/plugin-sdk/thread-ownership";
...
function resolveOwnershipAgent(config: AutoCrabConfig): { id: string; name: string } {
