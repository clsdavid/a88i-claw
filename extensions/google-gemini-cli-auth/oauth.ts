...
import { fetchWithSsrFGuard, isWSL2Sync } from "autocrab/plugin-sdk/google-gemini-cli-auth";

const CLIENT_ID_KEYS = ["AUTOCRAB_GEMINI_OAUTH_CLIENT_ID", "GEMINI_CLI_OAUTH_CLIENT_ID"];
      ...
      try {
        ...
        res.end(
          "<!doctype html><html><head><meta charset='utf-8'/></head>" +
            ...
            "<p>You can close this window and return to AutoCrab.</p></body></html>",
        );
