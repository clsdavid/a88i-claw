import type { AutoCrabPluginApi } from "autocrab/plugin-sdk/discord";
import {
  autoBindSpawnedDiscordSubagent,
  listThreadBindingsBySessionKey,
  resolveDiscordAccount,
  unbindThreadBindingsBySessionKey,
} from "autocrab/plugin-sdk/discord";
...
export function registerDiscordSubagentHooks(api: AutoCrabPluginApi) {
