...
import type { AutoCrabConfig } from "autocrab/plugin-sdk/nostr";
...
function resolveConfiguredDefaultNostrAccountId(cfg: AutoCrabConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: AutoCrabConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: AutoCrabConfig): string {
