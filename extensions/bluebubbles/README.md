...
This directory contains the **BlueBubbles external channel plugin** for AutoCrab.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `autocrab/plugin-sdk` helpers.
