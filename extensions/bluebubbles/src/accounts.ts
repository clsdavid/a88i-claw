...
import type { AutoCrabConfig } from "autocrab/plugin-sdk/bluebubbles";
...
export function listBlueBubblesAccountIds(cfg: AutoCrabConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: AutoCrabConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: AutoCrabConfig): ResolvedBlueBubblesAccount[] {
