...
import { resolveChannelMediaMaxBytes, type AutoCrabConfig } from "autocrab/plugin-sdk/bluebubbles";
...
function resolveMediaLocalRoots(params: { cfg: AutoCrabConfig; accountId?: string }): string[] {
