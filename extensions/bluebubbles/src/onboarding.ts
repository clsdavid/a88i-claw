import type {
  ...
  DmPolicy,
  WizardPrompter,
} from "autocrab/plugin-sdk/bluebubbles";
import {
  DEFAULT_ACCOUNT_ID,
...
function setBlueBubblesDmPolicy(cfg: AutoCrabConfig, dmPolicy: DmPolicy): AutoCrabConfig {
  const allowFrom =
  ...
  configure: async ({ cfg, prompter, accountOverrides, shouldPromptAccountIds }) => {
    ...
    await prompter.note(
      [
        ...
        "2. Add your AutoCrab gateway URL + webhook path",
