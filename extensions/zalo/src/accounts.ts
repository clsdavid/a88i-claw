...
} from "autocrab/plugin-sdk/account-id";
import type { AutoCrabConfig } from "autocrab/plugin-sdk/zalo";
...
export function listZaloAccountIds(cfg: AutoCrabConfig): string[] {
...
export function resolveDefaultZaloAccountId(cfg: AutoCrabConfig): string {
...
function mergeZaloAccountConfig(cfg: AutoCrabConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: AutoCrabConfig): ResolvedZaloAccount[] {
