import type {
  ...
  AutoCrabConfig,
} from "autocrab/plugin-sdk/zalo";
import { extractToolSend, jsonResult, readStringParam } from "autocrab/plugin-sdk/zalo";
import { listEnabledZaloAccounts } from "./accounts.js";
import { sendMessageZalo } from "./send.js";

const providerId = "zalo";

function listEnabledAccounts(cfg: AutoCrabConfig) {
