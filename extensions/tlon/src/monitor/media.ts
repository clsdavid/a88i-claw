...
import { fetchWithSsrFGuard } from "autocrab/plugin-sdk/tlon";
import { getDefaultSsrFPolicy } from "../urbit/context.js";

// Default to AutoCrab workspace media directory
const DEFAULT_MEDIA_DIR = path.join(homedir(), ".autocrab", "workspace", "media", "inbound");
 ...
 * Format matches AutoCrab's expected attachment structure.
 */
