...
vi.mock("autocrab/plugin-sdk/tlon", async (importOriginal) => {
  const actual = await importOriginal<typeof import("autocrab/plugin-sdk/tlon")>();
  return {
    ...actual,
...
describe("uploadImageFromUrl", () => {
  ...
  it("fetches image and calls uploadFile, returns uploaded URL", async () => {
    const { fetchWithSsrFGuard } = await import("autocrab/plugin-sdk/tlon");
