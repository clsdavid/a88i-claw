...
import type { AutoCrabConfig } from "autocrab/plugin-sdk/zalouser";
...
export function listZalouserAccountIds(cfg: AutoCrabConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: AutoCrabConfig): string {
...
function mergeZalouserAccountConfig(cfg: AutoCrabConfig, accountId: string): ZalouserAccountConfig {
