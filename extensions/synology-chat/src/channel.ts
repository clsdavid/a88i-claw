/**
 * Synology Chat Channel Plugin for AutoCrab.
 *
...
} from "autocrab/plugin-sdk/synology-chat";
import { z } from "zod";
...
export function createSynologyChatPlugin() {
  return {
    ...
    meta: {
      ...
      blurb: "Connect your Synology NAS Chat to AutoCrab",
      order: 90,
    },
    ...
    pairing: {
      ...
      notifyApproval: async ({ cfg, id }: { cfg: any; id: string }) => {
        ...
        await sendMessage(
          account.incomingUrl,
          "AutoCrab: your access has been approved.",
          id,
    ...
    security: {
      resolveDmPolicy: ({
        ...
        return {
          ...
          approveHint: "autocrab pairing approve synology-chat <code>",
