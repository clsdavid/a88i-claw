...
class Config:
    ...
    # Model settings
    model_name: str = "qwen3.5:35b"  # Default for Ollama/local
    backend_type: str = "ollama"  # ollama, llama_cpp, , deepseek, openai
    ...
    memory_dir: str = os.path.expanduser("~/.autocrab/workspace")
