...
public typealias AutoCrabPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias AutoCrabPlatformImage = UIImage
#endif

public struct AutoCrabChatUsageCost: Codable, Hashable, Sendable {
...
public struct AutoCrabChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: AutoCrabChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(AutoCrabChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct AutoCrabChatMessageContent: Codable, Hashable, Sendable {
...
public struct AutoCrabChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [AutoCrabChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: AutoCrabChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [AutoCrabChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: AutoCrabChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(AutoCrabChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([AutoCrabChatMessageContent].self, forKey: .content) {
...
public struct AutoCrabChatHistoryPayload: Codable, Sendable {
...
public struct AutoCrabSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct AutoCrabSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [AutoCrabSessionPreviewItem]
}

public struct AutoCrabSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [AutoCrabSessionPreviewEntry]

    public init(ts: Int, previews: [AutoCrabSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct AutoCrabChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct AutoCrabChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct AutoCrabAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct AutoCrabChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct AutoCrabGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct AutoCrabPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: AutoCrabPlatformImage?
...
public struct AutoCrabChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
