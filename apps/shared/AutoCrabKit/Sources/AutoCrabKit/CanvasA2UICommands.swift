...
public enum AutoCrabCanvasA2UICommand: String, Codable, Sendable {
...
public struct AutoCrabCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct AutoCrabCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
