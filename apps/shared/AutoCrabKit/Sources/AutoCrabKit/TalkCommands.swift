...
public enum AutoCrabTalkCommand: String, Codable, Sendable {
...
public struct AutoCrabTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct AutoCrabTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
