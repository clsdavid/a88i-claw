...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: AutoCrabProtocol.AnyCodable]?
    {
        ...
        return [
            "id": AutoCrabProtocol.AnyCodable(identity.deviceId),
            "publicKey": AutoCrabProtocol.AnyCodable(publicKey),
            "signature": AutoCrabProtocol.AnyCodable(signature),
            "signedAt": AutoCrabProtocol.AnyCodable(signedAtMs),
            "nonce": AutoCrabProtocol.AnyCodable(nonce),
        ]
    }
}
