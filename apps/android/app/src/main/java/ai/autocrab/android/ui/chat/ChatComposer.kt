...
import ai.autocrab.android.ui.mobileSurface
import ai.autocrab.android.ui.mobileText
import ai.autocrab.android.ui.mobileTextSecondary
import ai.autocrab.android.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.autocrab.android.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.autocrab.android.ui.mobileFontFamily,
