...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/clsdavid/autocrab") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/clsdavid/autocrab")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://autocrab.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "AutoCrabBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "AutoCrabBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "AutoCrabGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "AutoCrabGitCommit") as? String) ??
            "unknown"
    }
