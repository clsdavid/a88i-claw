...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = AutoCrabConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = AutoCrabConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = AutoCrabConfigFile.loadDict()
            ...
            AutoCrabConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/autocrab"
        state.remoteCliPath = ""
        return state
    }
}
