...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .autocrabSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? AutoCrabPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? AutoCrabPaths.stateDirURL.path
...
extension Notification.Name {
    static let autocrabSelectSettingsTab = Notification.Name("autocrabSelectSettingsTab")
}
