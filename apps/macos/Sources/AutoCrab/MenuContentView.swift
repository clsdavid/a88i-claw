...
/// Menu contents for the AutoCrab menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("About AutoCrab") { self.open(tab: .about) }
    ...
    private var connectionLabel: String {
        ...
        case .unconfigured:
            "AutoCrab Not Configured"
        case .remote:
            "Remote AutoCrab Active"
        case .local:
            "AutoCrab Active"
        }
    }
    ...
    private func open(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .autocrabSelectSettingsTab, object: tab)
        }
    }
