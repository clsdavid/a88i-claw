...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: AutoCrabPhotosLatestParams) async throws -> AutoCrabPhotosLatestPayload {
        ...
        var results: [AutoCrabPhotoPayload] = []
        ...
        return AutoCrabPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> AutoCrabPhotoPayload
    {
