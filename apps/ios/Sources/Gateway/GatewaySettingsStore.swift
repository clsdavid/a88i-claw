...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.autocrab.gateway"
    private static let nodeService = "ai.autocrab.node"
    private static let talkService = "ai.autocrab.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.autocrab.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.autocrab.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("autocrab-gateway.log")
    }
