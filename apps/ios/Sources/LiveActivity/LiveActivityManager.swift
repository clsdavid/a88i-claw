...
final class LiveActivityManager {
    ...
    private let logger = Logger(subsystem: "ai.autocrab.ios", category: "LiveActivity")
    private var currentActivity: Activity<AutoCrabActivityAttributes>?
    ...
    func startActivity(agentName: String, sessionKey: String) {
        ...
        let attributes = AutoCrabActivityAttributes(agentName: agentName, sessionKey: sessionKey)
    ...
    private func hydrateCurrentAndPruneDuplicates() {
        let active = Activity<AutoCrabActivityAttributes>.activities
    ...
    private func updateCurrent(state: AutoCrabActivityAttributes.ContentState) {
    ...
    private func connectingState() -> AutoCrabActivityAttributes.ContentState {
        AutoCrabActivityAttributes.ContentState(
    ...
    private func idleState() -> AutoCrabActivityAttributes.ContentState {
        AutoCrabActivityAttributes.ContentState(
            statusText: "Idle",
            isIdle: true,
            isDisconnected: false,
    ...
    private func disconnectedState() -> AutoCrabActivityAttributes.ContentState {
        AutoCrabActivityAttributes.ContentState(
