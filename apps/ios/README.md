# AutoCrab iOS (Super Alpha)

NO TEST FLIGHT AVAILABLE AT THIS POINT

This iPhone app is super-alpha and internal-use only. It connects to an AutoCrab Gateway as a `role: node`.
...
- `apps/ios/Sources/AutoCrab.entitlements` sets `aps-environment` to `development`.
