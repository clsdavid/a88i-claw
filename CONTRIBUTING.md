...
- Test locally with your AutoCrab instance
...
If you're an experienced contributor who wants to help shape AutoCrab's direction — whether through code, docs, or community — we'd like to hear from you.

Being a maintainer is a responsibility, not an honorary title. We expect active, consistent involvement — triaging issues, reviewing PRs, and helping move the project forward.

Still interested? Email contributing@autocrab.ai with:

- Links to your PRs on AutoCrab (if you don't have any, start there first)
...
For issues that don't fit a specific repo, or if you're unsure, email **security@autocrab.ai** and we'll route it.
