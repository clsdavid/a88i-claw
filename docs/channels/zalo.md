...
- Install via CLI: `autocrab plugins install @autocrab/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `autocrab plugins install ./extensions/zalo`
   - From npm (if published): `autocrab plugins install @autocrab/zalo`
...
- Approve via:
  - `autocrab pairing list zalo`
  - `autocrab pairing approve zalo <CODE>`
...
- Example: `autocrab message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `autocrab channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `autocrab logs --follow`
