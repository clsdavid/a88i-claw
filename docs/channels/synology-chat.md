---
summary: "Synology Chat webhook setup and AutoCrab config"
read_when:
  - Setting up Synology Chat with AutoCrab
...
```bash
autocrab plugins install ./extensions/synology-chat
```
...
3. Point the outgoing webhook URL to your AutoCrab gateway:
   - `https://gateway-host/webhook/synology` by default.
   - Or your custom `channels.synology-chat.webhookPath`.
4. Configure `channels.synology-chat` in AutoCrab.
...
- Pairing approvals work with:
  - `autocrab pairing list synology-chat`
  - `autocrab pairing approve synology-chat <CODE>`
...
```bash
autocrab message send --channel synology-chat --target 123456 --text "Hello from AutoCrab"
autocrab message send --channel synology-chat --target synology-chat:123456 --text "Hello again"
```
