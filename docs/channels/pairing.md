...
read_when:
  ...
  - Reviewing AutoCrab security posture
title: "Pairing"
---

# Pairing

“Pairing” is AutoCrab’s explicit **owner approval** step.
...
Stored under `~/.autocrab/credentials/`:
...
3. On your phone, open the AutoCrab iOS app → Settings → Gateway.
...
- The legacy `node.pair.*` API (CLI: `autocrab nodes pending/approve`) is a
