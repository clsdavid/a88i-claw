...
You can point AutoCrab at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or AutoCrab
...
- [Anthropic provider](/providers/anthropic) - Native AutoCrab integration with Claude setup-token or API keys
