---
summary: "Use Kilo Gateway's unified API to access many models in AutoCrab"
read_when:
  - You want a single API key for many LLMs
  - You want to run models via Kilo Gateway in AutoCrab
---
...
```bash
autocrab onboard --kilocode-api-key <key>
```
