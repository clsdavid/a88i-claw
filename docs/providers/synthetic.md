---
summary: "Use Synthetic's Anthropic-compatible API in AutoCrab"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. AutoCrab registers it as the
...
Note: AutoCrab's Anthropic client appends `/v1` to the base URL, so use
