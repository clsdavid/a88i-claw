---
summary: "Use Qianfan's unified API to access many models in AutoCrab"
read_when:
...
3. AutoCrab installed on your system
...
4. Copy the API key for use with AutoCrab

## CLI setup

```bash
autocrab onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [AutoCrab Configuration](/gateway/configuration)
