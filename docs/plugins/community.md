...
read_when:
  - You want to publish a third-party AutoCrab plugin
...
This page tracks high-quality **community-maintained plugins** for AutoCrab.

We accept PRs that add community plugins here when they meet the quality bar.

## Required for listing

- Plugin package is published on npmjs (installable via `autocrab plugins install <npm-spec>`).
...
- **Plugin Name** — short description
  ...
  install: `autocrab plugins install @scope/package`

## Listed plugins

- **WeChat** — Connect AutoCrab to WeChat personal accounts via WeChatPadPro (iPad protocol). Supports text, image, and file exchange with keyword-triggered conversations.
  npm: `@icesword760/autocrab-wechat`
  repo: `https://github.com/icesword0760/autocrab-wechat`
  install: `autocrab plugins install @icesword760/autocrab-wechat`
