...
AutoCrab ships three update channels:
...
When you **explicitly** switch channels with `--channel`, AutoCrab also aligns
the install method:
...
When you switch channels with `autocrab update`, AutoCrab also syncs plugin sources:
