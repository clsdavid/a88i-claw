...
- Or set `skills."nano-banana-pro".apiKey` / `skills."nano-banana-pro".env.GEMINI_API_KEY` in `~/.autocrab/autocrab.json`
...
- The script prints a `MEDIA:` line for AutoCrab to auto-attach on supported chat providers.
