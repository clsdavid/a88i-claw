    ...
    await withTempHome(
      async (tempHome) => {
        ...
        const env = {
          ...
          AUTOCRAB_TEST_FAST: "1",
        };
        delete env.AUTOCRAB_HOME;
        delete env.AUTOCRAB_STATE_DIR;
        delete env.AUTOCRAB_CONFIG_PATH;
        delete env.VITEST;

        const entry = path.resolve(process.cwd(), "autocrab.mjs");
