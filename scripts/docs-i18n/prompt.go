...
- Keep product names in English: AutoCrab, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the AutoCrab Gateway, use “Gateway 网关”.
