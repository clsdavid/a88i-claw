...
# Output:
# - dist/AutoCrab.app
# - dist/AutoCrab-<version>.zip
# - dist/AutoCrab-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.autocrab.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/AutoCrab.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/AutoCrab-$VERSION.zip"
DMG="$ROOT_DIR/dist/AutoCrab-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/AutoCrab-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/AutoCrab-$VERSION.dSYM.zip"
