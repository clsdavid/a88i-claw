...
if [[ -z "$version_content" ]]; then
  echo "<h2>AutoCrab $VERSION</h2>"
  echo "<p>Latest AutoCrab update.</p>"
  echo "<p><a href=\"https://github.com/autocrab/autocrab/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
