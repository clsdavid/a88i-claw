...
show_usage() {
    cat << EOF
clawlog - AutoCrab Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View AutoCrab logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    AutoCrab logs flow through the macOS unified log (subsystem: ai.autocrab).
