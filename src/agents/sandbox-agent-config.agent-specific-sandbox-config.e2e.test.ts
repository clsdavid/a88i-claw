...
async function resolveContext(config: AutoCrabConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): AutoCrabConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
