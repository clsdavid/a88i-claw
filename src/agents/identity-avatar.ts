...
function resolveAvatarSource(cfg: AutoCrabConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: AutoCrabConfig, agentId: string): AgentAvatarResolution {
