...
const CLEANUP_STATE_KEY = Symbol.for("autocrab.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("autocrab.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("autocrab.sessionWriteLockWatchdogState");
