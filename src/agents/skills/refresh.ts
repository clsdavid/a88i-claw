...
function resolveWatchPaths(workspaceDir: string, config?: AutoCrabConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: AutoCrabConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: AutoCrabConfig }) {
