...
describe("subagent announce formatting", () => {
  ...
  afterAll(() => {
    ...
    process.env.AUTOCRAB_TEST_FAST = previousFastTestEnv;
  });

  beforeEach(() => {
    // AUTOCRAB_TEST_FAST is set in beforeAll before module import
  ...
  it("sends instructional message to main agent with status and findings", async () => {
    ...
    expect(msg).toContain("AutoCrab runtime context (internal):");
