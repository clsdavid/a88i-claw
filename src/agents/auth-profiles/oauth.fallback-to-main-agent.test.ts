...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveAutoCrabAgentDir() returns mainAgentDir
    process.env.AUTOCRAB_STATE_DIR = tmpDir;
    process.env.AUTOCRAB_AGENT_DIR = mainAgentDir;
