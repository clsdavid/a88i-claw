...
describe("handleSlackAction", () => {
  function slackConfig(overrides?: Record<string, unknown>): AutoCrabConfig {
    return {
      channels: {
        slack: {
          botToken: "tok",
  ...
  async function resolveReadToken(cfg: AutoCrabConfig): Promise<string | undefined> {
  ...
  async function resolveSendToken(cfg: AutoCrabConfig): Promise<string | undefined> {
    sendSlackMessage.mockClear();
