...
export function resolveSessionToolsVisibility(cfg: AutoCrabConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: AutoCrabConfig): "spawned" | "all" {
...
export function createAgentToAgentPolicy(cfg: AutoCrabConfig): AgentToAgentPolicy {
