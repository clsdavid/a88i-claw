...
function asAutoCrabConfig(config: Partial<AutoCrabConfig>): AutoCrabConfig {
  return config as AutoCrabConfig;
}

function createToolConfig() {
  return asAutoCrabConfig({ agents: { list: [{ id: "main", default: true }] } });
}

function createMemoryGetToolOrThrow(config: AutoCrabConfig = createToolConfig()) {
