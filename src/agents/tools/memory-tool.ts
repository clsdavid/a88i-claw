...
function resolveMemoryToolContext(options: { config?: AutoCrabConfig; agentSessionKey?: string }) {
...
function resolveMemoryCitationsMode(cfg: AutoCrabConfig): MemoryCitationsMode {
