...
type WebSearchConfig = NonNullable<AutoCrabConfig["tools"]>["web"] extends infer Web
...
function resolveSearchConfig(cfg?: AutoCrabConfig): WebSearchConfig {
...
function missingSearchKeyPayload(provider: (typeof SEARCH_PROVIDERS)[number]) {
  ...
  return {
    ...
    message: `web_search needs a Brave Search API key. Run \`${formatCliCommand("autocrab configure --section web")}\` to store it, or set BRAVE_API_KEY in the Gateway environment.`,
    docs: "https://docs.autocrab.ai/tools/web",
  };
}
  ...
  return withTrustedWebSearchEndpoint(
    {
      ...
      init: {
        ...
        headers: {
          ...
          "HTTP-Referer": "https://autocrab.ai",
          "X-Title": "AutoCrab Web Search",
        },
