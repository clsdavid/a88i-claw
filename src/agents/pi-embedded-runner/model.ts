...
export function resolveModel(
  ...
  const resolvedAgentDir = agentDir ?? resolveAutoCrabAgentDir();
...
const LOCAL_PROVIDER_HINTS: Record<string, string> = {
  ollama:
    ...
    'Set OLLAMA_API_KEY="ollama-local" (any value works) or run "autocrab configure". ' +
    "See: https://docs.autocrab.ai/providers/ollama",
  vllm:
    "vLLM requires authentication to be registered as a provider. " +
    'Set VLLM_API_KEY (any value works) or run "autocrab configure". ' +
    "See: https://docs.autocrab.ai/providers/vllm",
};
