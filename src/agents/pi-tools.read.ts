...
function resolveAdaptiveReadMaxBytes(options?: AutoCrabReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createAutoCrabReadTool(base, {
...
export function createAutoCrabReadTool(
  base: AnyAgentTool,
  options?: AutoCrabReadToolOptions,
): AnyAgentTool {
