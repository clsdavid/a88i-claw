...
export const DEFAULT_SANDBOX_IMAGE = "autocrab-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "autocrab-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "autocrab-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "autocrab-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "autocrab-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "autocrab-sandbox-browser";
