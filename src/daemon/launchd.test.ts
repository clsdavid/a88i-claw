...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.autocrab.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", AUTOCRAB_PROFILE: "default" },
    });
...
describe("launchd bootstrap repair", () => {
  it("bootstraps and kickstarts the resolved label", async () => {
    ...
    const label = "ai.autocrab.gateway";
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.autocrab.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when AUTOCRAB_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.autocrab.gateway.plist",
    },
    {
      name: "uses profile-specific label when AUTOCRAB_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", AUTOCRAB_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.autocrab.jbphoenix.plist",
    },
    {
      name: "prefers AUTOCRAB_LAUNCHD_LABEL over AUTOCRAB_PROFILE",
      env: {
        HOME: "/Users/test",
        AUTOCRAB_PROFILE: "jbphoenix",
        AUTOCRAB_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from AUTOCRAB_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        AUTOCRAB_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty AUTOCRAB_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        AUTOCRAB_PROFILE: "myprofile",
        AUTOCRAB_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.autocrab.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
