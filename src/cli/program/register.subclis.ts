...
const shouldRegisterPrimaryOnly = (argv: string[]) => {
  if (isTruthyEnvValue(process.env.AUTOCRAB_DISABLE_LAZY_SUBCOMMANDS)) {
    return false;
  }
...
const shouldEagerRegisterSubcommands = (_argv: string[]) => {
  return isTruthyEnvValue(process.env.AUTOCRAB_DISABLE_LAZY_SUBCOMMANDS);
};

const loadConfig = async (): Promise<AutoCrabConfig> => {
...
const entries: SubCliEntry[] = [
  ...
  {
    name: "docs",
    description: "Search the live AutoCrab docs",
    hasSubcommands: false,
    register: async (program) => {
  ...
  {
    name: "plugins",
    description: "Manage AutoCrab plugins and extensions",
    hasSubcommands: true,
    register: async (program) => {
