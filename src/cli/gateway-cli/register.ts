      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["autocrab gateway run", "Run the gateway in the foreground."],
            ["autocrab gateway status", "Show service status and probe reachability."],
            ["autocrab gateway discover", "Find local and wide-area gateway beacons."],
            ["autocrab gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.autocrab.ai/cli/gateway")}\n`,
      ),
  );
