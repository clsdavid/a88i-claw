    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["autocrab directory self --channel slack", "Show the connected account identity."],
          [
            'autocrab directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["autocrab directory groups list --channel discord", "List available groups/channels."],
          [
            "autocrab directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.autocrab.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
