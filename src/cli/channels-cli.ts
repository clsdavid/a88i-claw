    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["autocrab channels list", "List configured channels and auth profiles."],
          ["autocrab channels status --probe", "Run channel status checks and probes."],
          [
            "autocrab channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["autocrab channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.autocrab.ai/cli/channels",
        )}\n`,
    );
