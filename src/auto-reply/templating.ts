import type { StickerMetadata } from "@autocrab/telegram/src/bot/types.js";
...
export type MsgContext = {
  ...
  OutputDir?: string;
  OutputBase?: string;
  /** Remote host for SCP when media lives on a different machine (e.g., autocrab@192.168.64.3). */
