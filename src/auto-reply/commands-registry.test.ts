...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@autocrab", { botUsername: "autocrab" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@autocrab args", {
        botUsername: "autocrab",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@autocrab: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "autocrab" })).toBe(
      "/help@otherbot",
    );
  });
