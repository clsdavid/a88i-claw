...
function resolveAcpStreamCoalesceIdleMs(cfg: AutoCrabConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: AutoCrabConfig): number {
...
export function resolveAcpProjectionSettings(cfg: AutoCrabConfig): AcpProjectionSettings {
