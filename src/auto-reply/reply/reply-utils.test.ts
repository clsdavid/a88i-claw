...
describe("matchesMentionWithExplicit", () => {
  const mentionRegexes = [/\bautocrab\b/i];
  ...
  it("resolves known variables, aliases, and case-insensitive tokens", () => {
    const cases = [
      ...
      },
      {
        ...
        values: {
          identityName: "AutoCrab",
          provider: "anthropic",
          model: "claude-opus-4-5",
          thinkingLevel: "high",
        },
        expected: "[AutoCrab] anthropic/claude-opus-4-5 (think:high)",
      },
    ] as const;
