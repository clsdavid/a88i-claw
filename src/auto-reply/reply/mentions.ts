...
function resolveMentionPatterns(cfg: AutoCrabConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: AutoCrabConfig | undefined, agentId?: string): RegExp[] {
