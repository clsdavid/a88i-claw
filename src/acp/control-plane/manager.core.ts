...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: AutoCrabConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: AutoCrabConfig): AcpManagerObservabilitySnapshot {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: AutoCrabConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: AutoCrabConfig }): Promise<void> {
