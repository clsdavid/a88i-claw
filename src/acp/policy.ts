...
export function isAcpEnabledByPolicy(cfg: AutoCrabConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: AutoCrabConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: AutoCrabConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: AutoCrabConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: AutoCrabConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: AutoCrabConfig, agentId: string): boolean {
