...
let originalAutoCrabTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalAutoCrabTestConsole = process.env.AUTOCRAB_TEST_CONSOLE;
  process.env.AUTOCRAB_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalAutoCrabTestConsole === undefined) {
    delete process.env.AUTOCRAB_TEST_CONSOLE;
  } else {
    process.env.AUTOCRAB_TEST_CONSOLE = originalAutoCrabTestConsole;
  }
