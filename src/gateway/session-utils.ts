...
import { type AutoCrabConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: AutoCrabConfig): string[] {
...
export function listAgentsForGateway(cfg: AutoCrabConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: AutoCrabConfig): string {
...
function resolveSessionStoreAgentId(cfg: AutoCrabConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: AutoCrabConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: AutoCrabConfig): GatewaySessionsDefaults {
