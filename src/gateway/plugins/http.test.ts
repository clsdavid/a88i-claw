...
import { createTestRegistry as createBaseTestRegistry } from "../../test-utils/channel-plugins.js";
...
const createTestRegistry = (arg?: unknown) => {
  const base = createBaseTestRegistry([]);
  if (arg && typeof arg === "object" && "httpRoutes" in arg) {
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    base.httpRoutes = (arg as { httpRoutes: any }).httpRoutes;
  }
  return base;
};
