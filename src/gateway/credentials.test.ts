...
function cfg(input: Partial<AutoCrabConfig>): AutoCrabConfig {
  return input as AutoCrabConfig;
}

type ResolveFromConfigInput = Parameters<typeof resolveGatewayCredentialsFromConfig>[0];
type GatewayConfig = NonNullable<AutoCrabConfig["gateway"]>;
...
const DEFAULT_GATEWAY_ENV = {
  ...
  AUTOCRAB_GATEWAY_PASSWORD: "env-password",
