...
export function listBindings(cfg: AutoCrabConfig): AgentRouteBinding[] {
...
export function listBoundAccountIds(cfg: AutoCrabConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: AutoCrabConfig) {
