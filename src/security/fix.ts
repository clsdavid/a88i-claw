...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof AutoCrabConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: AutoCrabConfig; env: NodeJS.ProcessEnv }): {
  cfg: AutoCrabConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
