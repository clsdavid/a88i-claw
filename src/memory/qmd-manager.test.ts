...
describe("QmdMemoryManager", () => {
  ...
  let stateDir: string;
  let cfg: AutoCrabConfig;
  const agentId = "main";

  async function createManager(params?: { mode?: "full" | "status"; cfg?: AutoCrabConfig }) {
  ...
  afterEach(() => {
    ...
    delete (globalThis as Record<string, unknown>).__autocrabMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__autocrabMcporterColdStartWarned;
  });
