...
function mergeIMessageAccountConfig(cfg: AutoCrabConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: AutoCrabConfig): ResolvedIMessageAccount[] {
