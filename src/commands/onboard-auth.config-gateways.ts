...
export function applyVercelAiGatewayProviderConfig(cfg: AutoCrabConfig): AutoCrabConfig {
...
export function applyVercelAiGatewayConfig(cfg: AutoCrabConfig): AutoCrabConfig {
