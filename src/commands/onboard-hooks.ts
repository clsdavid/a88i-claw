...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.autocrab.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("autocrab hooks list")}`,
      `  ${formatCliCommand("autocrab hooks enable <name>")}`,
      `  ${formatCliCommand("autocrab hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
