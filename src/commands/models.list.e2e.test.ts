...
const ensureAutoCrabModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveAutoCrabAgentDir = vi.fn().mockReturnValue("/tmp/autocrab-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/autocrab-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureAutoCrabModelsJson,
}));

vi.mock("../agents/agent-paths.js", () => ({
  resolveAutoCrabAgentDir,
}));
