...
export function applyOpenrouterProviderConfig(cfg: AutoCrabConfig): AutoCrabConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyOpenrouterConfig(cfg: AutoCrabConfig): AutoCrabConfig {
  const next = applyOpenrouterProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, OPENROUTER_DEFAULT_MODEL_REF);
}

export function applyMoonshotProviderConfig(cfg: AutoCrabConfig): AutoCrabConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: AutoCrabConfig): AutoCrabConfig {
...
export function applyMoonshotConfig(cfg: AutoCrabConfig): AutoCrabConfig {
  const next = applyMoonshotProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyMoonshotConfigCn(cfg: AutoCrabConfig): AutoCrabConfig {
  const next = applyMoonshotProviderConfigCn(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyKimiCodeProviderConfig(cfg: AutoCrabConfig): AutoCrabConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: AutoCrabConfig): AutoCrabConfig {
  const next = applyKimiCodeProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, KIMI_CODING_MODEL_REF);
}

export function applySyntheticProviderConfig(cfg: AutoCrabConfig): AutoCrabConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: AutoCrabConfig): AutoCrabConfig {
  const next = applySyntheticProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, SYNTHETIC_DEFAULT_MODEL_REF);
}

export function applyXiaomiProviderConfig(cfg: AutoCrabConfig): AutoCrabConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: AutoCrabConfig): AutoCrabConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: AutoCrabConfig): AutoCrabConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: AutoCrabConfig): AutoCrabConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: AutoCrabConfig): AutoCrabConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: AutoCrabConfig): AutoCrabConfig {
 ...
 */
export function applyHuggingfaceProviderConfig(cfg: AutoCrabConfig): AutoCrabConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyHuggingfaceConfig(cfg: AutoCrabConfig): AutoCrabConfig {
  const next = applyHuggingfaceProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, HUGGINGFACE_DEFAULT_MODEL_REF);
}

export function applyXaiProviderConfig(cfg: AutoCrabConfig): AutoCrabConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: AutoCrabConfig): AutoCrabConfig {
  const next = applyXaiProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, XAI_DEFAULT_MODEL_REF);
}

export function applyMistralProviderConfig(cfg: AutoCrabConfig): AutoCrabConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMistralConfig(cfg: AutoCrabConfig): AutoCrabConfig {
 ...
 */
export function applyKilocodeProviderConfig(cfg: AutoCrabConfig): AutoCrabConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyKilocodeConfig(cfg: AutoCrabConfig): AutoCrabConfig {
...
export function applyQianfanProviderConfig(cfg: AutoCrabConfig): AutoCrabConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: AutoCrabConfig): AutoCrabConfig {
