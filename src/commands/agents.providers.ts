...
function resolveDefaultAccountId(cfg: AutoCrabConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: AutoCrabConfig): boolean {
...
export function summarizeBindings(cfg: AutoCrabConfig, bindings: AgentBinding[]): string[] {
