...
export function applyOpencodeZenProviderConfig(cfg: AutoCrabConfig): AutoCrabConfig {
...
export function applyOpencodeZenConfig(cfg: AutoCrabConfig): AutoCrabConfig {
