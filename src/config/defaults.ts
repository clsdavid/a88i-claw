...
function resolveAnthropicDefaultAuthMode(cfg: AutoCrabConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: AutoCrabConfig): AutoCrabConfig {
...
export function applyTalkApiKey(config: AutoCrabConfig): AutoCrabConfig {
...
export function applyTalkConfigNormalization(config: AutoCrabConfig): AutoCrabConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: AutoCrabConfig): AutoCrabConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: AutoCrabConfig): AutoCrabConfig {
...
export function applyLoggingDefaults(cfg: AutoCrabConfig): AutoCrabConfig {
...
export function applyContextPruningDefaults(cfg: AutoCrabConfig): AutoCrabConfig {
...
export function applyCompactionDefaults(cfg: AutoCrabConfig): AutoCrabConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
