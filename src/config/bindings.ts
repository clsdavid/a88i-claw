...
export function listConfiguredBindings(cfg: AutoCrabConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listRouteBindings(cfg: AutoCrabConfig): AgentRouteBinding[] {
  return listConfiguredBindings(cfg).filter(isRouteBinding);
}

export function listAcpBindings(cfg: AutoCrabConfig): AgentAcpBinding[] {
