/**
 * Hook system for AutoCrab agent events
 *
...
const _g = globalThis as typeof globalThis & {
  __autocrab_internal_hook_handlers__?: Map<string, InternalHookHandler[]>;
};
const handlers = (_g.__autocrab_internal_hook_handlers__ ??= new Map<
  string,
  InternalHookHandler[]
>());
