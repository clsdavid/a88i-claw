...
export function listWhatsAppAuthDirs(cfg: AutoCrabConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: AutoCrabConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: AutoCrabConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: AutoCrabConfig): ResolvedWhatsAppAccount[] {
