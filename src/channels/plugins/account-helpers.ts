...
export function createAccountListHelpers(channelKey: string) {
  function resolveConfiguredDefaultAccountId(cfg: AutoCrabConfig): string | undefined {
  ...
  function listAccountIds(cfg: AutoCrabConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: AutoCrabConfig): string {
