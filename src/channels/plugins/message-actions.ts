...
export function listChannelMessageActions(cfg: AutoCrabConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: AutoCrabConfig): boolean {
...
export function supportsChannelMessageCards(cfg: AutoCrabConfig): boolean {
