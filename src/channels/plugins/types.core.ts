...
export type ChannelAgentToolFactory = (params: { cfg?: AutoCrabConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: AutoCrabConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
   ...
   */
  listActions?: (params: { cfg: AutoCrabConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: AutoCrabConfig }) => boolean;
  supportsCards?: (params: { cfg: AutoCrabConfig }) => boolean;
