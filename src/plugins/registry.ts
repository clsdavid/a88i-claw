...
import type {
  AutoCrabPluginApi,
  AutoCrabPluginChannelRegistration,
  AutoCrabPluginCliRegistrar,
  AutoCrabPluginCommandDefinition,
  AutoCrabPluginHttpRouteAuth,
  AutoCrabPluginHttpRouteMatch,
  AutoCrabPluginHttpRouteHandler,
  AutoCrabPluginHttpRouteParams,
  AutoCrabPluginHookOptions,
  ProviderPlugin,
  AutoCrabPluginService,
  AutoCrabPluginToolContext,
...
export type PluginToolRegistration = {
  pluginId: string;
  factory: AutoCrabPluginToolFactory;
  names: string[];
  optional: boolean;
  source: string;
};
...
export type PluginCliRegistration = {
  pluginId: string;
  register: AutoCrabPluginCliRegistrar;
  commands: string[];
  source: string;
};
...
export type PluginServiceRegistration = {
  pluginId: string;
  service: AutoCrabPluginService;
  source: string;
};

export type PluginCommandRegistration = {
  pluginId: string;
  command: AutoCrabPluginCommandDefinition;
  source: string;
};
...
export function createPluginRegistry(registryParams: PluginRegistryParams) {
  ...
  const registerTool = (
    ...
    const factory: AutoCrabPluginToolFactory =
      typeof tool === "function" ? tool : (_ctx: AutoCrabPluginToolContext) => tool;
  ...
  const registerHook = (
    ...
    opts: AutoCrabPluginHookOptions | undefined,
    config: AutoCrabPluginApi["config"],
  ) => {
  ...
  const registerHttpRoute = (record: PluginRecord, params: AutoCrabPluginHttpRouteParams) => {
  ...
  const registerChannel = (
    record: PluginRecord,
    registration: AutoCrabPluginChannelRegistration | ChannelPlugin,
  ) => {
    const normalized =
      typeof (registration as AutoCrabPluginChannelRegistration).plugin === "object"
        ? (registration as AutoCrabPluginChannelRegistration)
  ...
  const registerCli = (
    record: PluginRecord,
    registrar: AutoCrabPluginCliRegistrar,
  ...
  const registerService = (record: PluginRecord, service: AutoCrabPluginService) => {
  ...
  const registerCommand = (record: PluginRecord, command: AutoCrabPluginCommandDefinition) => {
