...
export type AutoCrabPluginConfigSchema = {
...
export type AutoCrabPluginToolContext = {
...
export type AutoCrabPluginToolFactory = (
  ctx: AutoCrabPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type AutoCrabPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type AutoCrabPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type ProviderAuthResult = {
  ...
  configPatch?: Partial<AutoCrabConfig>;
  defaultModel?: string;
  notes?: string[];
};
...
export type AutoCrabPluginGatewayMethod = {
  method: string;
...
export type PluginCommandContext = {
  ...
  commandBody: string;
  /** Current AutoCrab configuration */
  config: AutoCrabConfig;
 ...
 */
export type AutoCrabPluginCommandDefinition = {
...
export type AutoCrabPluginHttpRouteAuth = "gateway" | "plugin";
export type AutoCrabPluginHttpRouteMatch = "exact" | "prefix";

export type AutoCrabPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean | void> | boolean | void;

export type AutoCrabPluginHttpRouteParams = {
  path: string;
  handler: AutoCrabPluginHttpRouteHandler;
  auth: AutoCrabPluginHttpRouteAuth;
  match?: AutoCrabPluginHttpRouteMatch;
  replaceExisting?: boolean;
};

export type AutoCrabPluginCliContext = {
  program: Command;
  config: AutoCrabConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type AutoCrabPluginCliRegistrar = (ctx: AutoCrabPluginCliContext) => void | Promise<void>;

export type AutoCrabPluginServiceContext = {
  config: AutoCrabConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type AutoCrabPluginService = {
  id: string;
  start: (ctx: AutoCrabPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: AutoCrabPluginServiceContext) => void | Promise<void>;
};

export type AutoCrabPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type AutoCrabPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  kind?: PluginKind;
  configSchema?: AutoCrabPluginConfigSchema;
  register?: (api: AutoCrabPluginApi) => void | Promise<void>;
  activate?: (api: AutoCrabPluginApi) => void | Promise<void>;
};

export type AutoCrabPluginModule =
  | AutoCrabPluginDefinition
  | ((api: AutoCrabPluginApi) => void | Promise<void>);

export type AutoCrabPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  logger: PluginLogger;
  registerTool: (
    tool: AnyAgentTool | AutoCrabPluginToolFactory,
    opts?: AutoCrabPluginToolOptions,
  ) => void;
  registerHook: (
    events: string | string[],
    handler: InternalHookHandler,
    opts?: AutoCrabPluginHookOptions,
  ) => void;
  registerHttpRoute: (params: AutoCrabPluginHttpRouteParams) => void;
  registerChannel: (registration: AutoCrabPluginChannelRegistration | ChannelPlugin) => void;
  registerGatewayMethod: (method: string, handler: GatewayRequestHandler) => void;
  registerCli: (registrar: AutoCrabPluginCliRegistrar, opts?: { commands?: string[] }) => void;
  registerService: (service: AutoCrabPluginService) => void;
   ...
   */
  registerCommand: (command: AutoCrabPluginCommandDefinition) => void;
