...
export const PLUGIN_MANIFEST_FILENAME = "autocrab.plugin.json";
...
// package.json "autocrab" metadata (used for onboarding/catalog)
...
export type AutoCrabPackageManifest = {
  extensions?: string[];
...
): AutoCrabPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
