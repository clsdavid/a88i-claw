...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/autocrab/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/autocrab/extensions",
        global: "/Users/x/.autocrab/extensions",
        workspace: "/Users/x/ws/.autocrab/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.autocrab/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/autocrab/extensions",
        global: "/Users/x/.autocrab/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.autocrab/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/autocrab/extensions",
        global: "/Users/x/.autocrab/extensions",
