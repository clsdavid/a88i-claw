...
function resolveResolutionLimits(config: AutoCrabConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: AutoCrabConfig): SecretProviderConfig {
