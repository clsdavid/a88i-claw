...
describe("tts", () => {
  ...
  describe("maybeApplyTtsToPayload", () => {
    ...
    const withMockedAutoTtsFetch = async (
      ...
      const prevPrefs = process.env.AUTOCRAB_TTS_PREFS;
      process.env.AUTOCRAB_TTS_PREFS = `/tmp/tts-test-${Date.now()}.json`;
      ...
      try {
        ...
        process.env.AUTOCRAB_TTS_PREFS = prevPrefs;
      }
    };

    const taggedCfg: AutoCrabConfig = {
      ...baseCfg,
      messages: {
        ...baseCfg.messages!,
