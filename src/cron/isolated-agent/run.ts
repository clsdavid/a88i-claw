...
export type RunCronAgentTurnResult = {
   ...
   * messages.  See: https://github.com/clsdavid/autocrab/issues/15692
   */
  delivered?: boolean;
  /**
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.AUTOCRAB_TEST_FAST === "1";
  ...
  // correct per-agent paths (e.g. ~/.autocrab/agents/<agentId>/agent/).
  ...
  const cfgWithAgentDefaults: AutoCrabConfig = {
    ...params.cfg,
      ...
      const fallbackResult = await runWithModelFallback({
        ...
        run: async (providerOverride, modelOverride, runOptions) => {
          ...
          if (isCliProvider(providerOverride, cfgWithAgentDefaults)) {
            ...
            // the configured timeoutSeconds. See: https://github.com/clsdavid/autocrab/issues/29774
