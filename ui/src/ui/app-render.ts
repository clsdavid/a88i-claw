      ...
      <header class="topbar">
        <div class="topbar-left">
          ...
          <div class="brand">
            <div class="brand-logo">
              <img src=${basePath ? `${basePath}/favicon.svg` : "/favicon.svg"} alt="AutoCrab" />
            </div>
            <div class="brand-text">
              <div class="brand-title">AUTOCRAB</div>
        ...
        <div class="topbar-status">
          <div class="pill">
            ...
            <span class="mono">${autoCrabVersion}</span>
          </div>
          <div class="pill">
